    ...
    public static class VisualStudioExtension
    {
        ...
        )
        {
            ...
            var candidates = installedVersions.Where(i =>
                    i.Version.Major == visualVersionMajorVersion
        ...
        {
            var vsInstallations = GetVisualStudioInstallationsFromQuery(visualVersionMajorVersion, allowPrereleaseVersions, requiredComponents, requiredWorkloads);
            return vsInstallations.FirstOrDefault()?.InstallationPath;
        }
